...
public class ShoppingCart1 extends ActivityBase implements GoodsCartListViewAdapter.ModifyCountInterface, GoodsCartListViewAdapter.CheckInterface {
        ...
        HtttpRequest.CreatGetRequst(UrlApi.URL_GETSHOPINGCARLIST, map1, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                ...
                if (response.startsWith("{")) {
                    ...
                    FullyLinearLayoutManager linearLayoutManager = new FullyLinearLayoutManager(ShoppingCart1.this);


                    shopingcartGoodsListview.setLayoutManager(linearLayoutManager);
                    shopingcartGoodsListview.setNestedScrollingEnabled(false);
                    adapter = new GoodsCartListViewAdapter(R.layout.item_shopingcart_goods, canBuy, ShoppingCart1.this);
                    shopingcartGoodsListview.setAdapter(adapter);

                    Drawable drawable = ContextCompat.getDrawable(ShoppingCart1.this, R.drawable.line_divider);
                    shopingcartGoodsListview.addItemDecoration(new SimpleDividerItemDecoration(ShoppingCart1.this, drawable, 5));

                    adapter.setCheckInterface(ShoppingCart1.this);
                    adapter.setModifyCountInterface(ShoppingCart1.this);
                    ...
                    /**c测试数据***/
//                   canBuy.get(1).setActivityEndTime("2017-09-26 20:00:00");
//                  canBuy.get(2).setActivityEndTime("2017/9/30 23:59:59");
                    //      canBuy.get(4).setActivityEndTime("2017-09-23 20:00:00");


                    // adapter.notifyDataSetChanged();
                    //适配失效的
                    MyLinearLayoutManager linearLayoutManager2 = new MyLinearLayoutManager(ShoppingCart1.this);
    ...
    private void showPopwiond(final int pos) {
        final Dialog bottomDialog = new Dialog(ShoppingCart1.this, R.style.BottomDialog);
        View contentView = LayoutInflater.from(ShoppingCart1.this).inflate(R.layout.popupwindow_cart, null);
            ...
            public void onResponse(String response, int id) {
                ...
                if (!response.contains(MConstant.HTTP404)) {
                    if (JSONObject.parseObject(response).get("dataStatus").toString().equals("1")) {
                        ...
                        Toast.makeText(ShoppingCart1.this, JSONObject.parseObject(response).get("describe").toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
            ...
            public void onResponse(String response, int id) {
                if (!response.contains(MConstant.HTTP404)) {
                    if ((int) JSONObject.parseObject(response).get("dataStatus") > 0) {
                        Toast.makeText(ShoppingCart1.this, "添加成功", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ShoppingCart1.this, "添加失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        HtttpRequest.CreatGetRequst(UrlApi.URL_GETFOOTHOSTORY, map, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                ...
                if (response.startsWith("{") && JSONObject.parseObject(response).get("obj") != null) {
                    ...
                    MyLinearLayoutManager linearLayoutManager3 = new MyLinearLayoutManager(ShoppingCart1.this);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.shopingcart_jiesuan:
                ...
                if (cheackedNum > 0) {
                    Intent intent = new Intent(ShoppingCart1.this, OrderBalanceActivity.class);
                    intent.putExtra("orderInfo", (Serializable) orderGoodsInfoList);
                    startActivity(intent);
                } else {
                    Toast.makeText(ShoppingCart1.this, "亲您没有选择商品", Toast.LENGTH_SHORT).show();
                }
...
//                break;
            case R.id.start_shoping:
                startActivity(new Intent(ShoppingCart1.this, MainPagerActivity.class).putExtra("fr", 0));
                break;
        }
    }
