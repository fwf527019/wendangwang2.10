 ...
 */
public class YouHuiQuanNotUsedAdapter extends BaseQuickAdapter<OfflineConpund.ObjBean, BaseViewHolder> {
    public YouHuiQuanNotUsedAdapter(int layoutResId, List<OfflineConpund.ObjBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, OfflineConpund.ObjBean item) {
