 ...
 */
public class OnlineYouHuiQuanNotUsedAdapter3 extends BaseQuickAdapter<LineCanNotCouponsData.DatasBean, BaseViewHolder> {
    public OnlineYouHuiQuanNotUsedAdapter3(int layoutResId, List<LineCanNotCouponsData.DatasBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, LineCanNotCouponsData.DatasBean item) {
