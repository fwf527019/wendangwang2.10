 ...
 */
public class FloorInfo2Adapter extends BaseQuickAdapter<FloorInfoData.DatasBean.ItemsBean, BaseViewHolder> {
    public FloorInfo2Adapter(int layoutResId, List<FloorInfoData.DatasBean.ItemsBean> data) {
