 ...
 */
public class FloorInfo3Adapter extends BaseQuickAdapter<FloorInfoData.DatasBean.ItemsBean, BaseViewHolder> {
    public FloorInfo3Adapter(int layoutResId, List<FloorInfoData.DatasBean.ItemsBean> data) {
