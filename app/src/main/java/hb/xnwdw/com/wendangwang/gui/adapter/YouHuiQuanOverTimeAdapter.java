 ...
 */
public class YouHuiQuanOverTimeAdapter extends BaseQuickAdapter<CouponInfoData.ObjBean, BaseViewHolder> {
    public YouHuiQuanOverTimeAdapter(int layoutResId, List<CouponInfoData.ObjBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, CouponInfoData.ObjBean item) {
                if (item != null && item.getCouponStatus() == 2) {
        ...
        ((RelativeLayout)(helper.getView(R.id.item_youhuiquan_relayout))).setBackgroundResource(R.drawable.overdue);
